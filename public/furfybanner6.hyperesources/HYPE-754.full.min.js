...
(function () {
    ...
    (function () {
        v.HYPE_754F = function (R, J, Na, je, sj, tj, Va, A, lc, mq, pd, df, fa, uj, Dg, ef, nq, oq, pq, ke) {
            function ff(a) {
                var b = zb(a);
            ...
            function mc(a, b) {
                ...
                if (!(fa != h || a == k || 0 < Ib || f == k || f.ob == h)) {
                    ...
                    if (!(0 == l && m == k)) {
                        ...
                        var q = m != k && 0 == l;
                        (m == k && 0 != l) == h
                            ? ((m = vj(a)), (m = wj(a, m, h)), m == k && (m = B.Body[Ha]({ elementId: a?.id })), (m.plugin = n(a, Om, {})), B.Composite.add(g, m), (f.Qa[j] = m))
                            : q == h && (B.Composite.remove(g, m), V(a, Om, m.plugin), delete f.Qa[j], (m = k));
                        f = n(a, ql, 0.5);
                        g = n(a, rl, 0.1);
                        j = n(a, Vl, 0.01);
                        q = n(a, sl, 0.001);
                        ...
                        if (m != k) {
                            l = 1 == l;
                            if (
                                1 < 1e5 * r.abs(m[Wb].x - c) ||
                                1 < 1e5 * r.abs(m[Wb].y - d) ||
                                1 < 1e5 * r.abs(m.angle - e) ||
                                m.restitution != f ||
                                m.friction != g ||
                                m.frictionAir != j ||
                                m.density != q ||
                                ...
                                m.isStatic != l && B.Body.setStatic(m, l),
                                    B.Body.setAngle(m, 0),
                                    l != h && B.Body.setDensity(m, q),
                                    B.Body.setPosition(m, { x: c, y: d }),
                                    B.Body.setAngle(m, e),
                                    m.Ga == k ? (B.Body.setVelocity(m, { x: c - t, y: d - u }), B.Body.setAngularVelocity(m, e - s)) : (B.Body.setVelocity(m, { x: 0, y: 0 }), B.Body.setAngularVelocity(m, 0)),
                                    (m.restitution = f),
                                    (m.friction = g),
                                    (m.frictionAir = j),
                                    B.Sleeping.set(m, p),
                                    (m.force = { x: 0, y: 0 }),
                                    (m.torque = 0),
                                    (m.positionImpulse = { x: 0, y: 0 }),
                                    (m.constraintImpulse = { x: 0, y: 0, angle: 0 }),
                                    (m.angularSpeed = 0),
                                    (m.motion = 0);
                            rd();
                    ...
                    if (!(0 == n(a, il, 0) || c == k)) {
                        ...
                        for (var d = [], e = b.oa.pairs.list, f = b.oa.pairs.table, g = 0; g < e[X]; g++)
                            for (var j = 0; j < c.parts[X]; j++)
                                if (e[g].bodyA == c.parts[j] || e[g].bodyB == c.parts[j]) {
                                    d[z](g);
                                    break;
                                }
            ...
            function wj(a, b, c) {
                ...
                var g = B.Vertices.centre(f),
                    j = n(a, Gm, p),
                    m = k;
                B.HypePlugin && B.HypePlugin.fromVerticesWithFallback
                    ? ((g = B.HypePlugin.fromVerticesWithFallback(g.x, g.y, f, { elementId: a?.id }, p, 0.1, 10, 1, e, c, j)), (m = g.physicsBody), (g = g.centerPoint))
                    : (m = B.Bodies.fromVertices(g.x, g.y, f, { elementId: a?.id }, p, 0.1, 10, 1));
            ...
            function Aj(a, b, c) {
                var d = n(a, ol, 0);
                if (Jc != h || 0 == d || 36 == d) return { x: b, y: c };
                var e = M[a?.id],
                    f = me(e),
                    g = hf(f),
                    j = Hg(f),
                ...
                D == h && N == p && O == p ? (m = c - (j[L] - g[L])) : D == h && N == h && O == p ? (m = (c + q / 2) / A - q / 2) : D == h && N == h && O == h ? (m = c) : O == h && (m = D == h && N == p ? c + (x - a) - (j[L] - g[L]) : c);
                if ((na == h || d == h) == h)
                    (c = s),
                        (b = x),
                        (g = s / f),
                        (x /= a),
                        (j = g),
                        na == h ? (j = g <= x ? g : x) : d == h && (j = g >= x ? g : x),
                        (f = c - f * j),
                        (a = b - a * j),
                        y == h && C == p ? (e -= f) : y == h && C == h && (e -= f / 2),
                        D == h && N == p ? (m -= a) : D == h && N == h && (m -= a / 2);
                return { x: e, y: m };
            }
            function gf(a) {
            ...
            function jf(a, b) {
                var c = r.max(a, b);
                return r.max(r.min(r[Gb](90 / c), 90), 6);
            }
            function vj(a) {
                var b = [],
                    c = M[a?.id],
                ...
                if (e != k) {
                        ...
                        if (m == k || 1 >= m) g = [];
                            ...
                            for (f = 0; f < e[X]; f++)
                                if (((j = e[f]), 0 == f)) {
                                    ...
                                    if (y > g && 0 <= u) l[z](E(j.x + r.cos(s) * q, j.y + r.sin(s) * q)), l[z](E(j.x + r.cos(t) * q, j.y + r.sin(t) * q));
                    ...
                    u = t = s = m = q = j = l = g = 0;
                    n(a, cj) == $f
                        ? ((g = d / 2), (j = d / 2), (m = d / 2), (t = d / 2), (l = c / 2), (q = c / 2), (s = c / 2), (u = c / 2))
                        : ((g = n(a, cj, 0)),
                            (m = n(a, dj, 0)),
                            (j = n(a, aj, 0)),
                            (e = n(a, bj, 0)),
                            (f = r.max(r.max(g + j, m + e), c)),
                            (l = r.max(r.max(g + m, j + e), d)),
                            (g = r.min(c * (g / f), d * (g / l))),
                            (j = r.min(c * (j / f), d * (j / l))),
                            (m = r.min(c * (m / f), d * (m / l))),
                            (t = r.min(c * (e / f), d * (e / l))),
                ...
                d = gf(a);
                a = [];
                for (j = 0; j < b[X]; j++) (g = qd(d, [b[j].x, b[j].y])), (c = r[Gb](g[0])), (g = r[Gb](g[1])), (0 == a[X] || a[a[X] - 1].x != c || a[a[X] - 1].y != g) && a[z]({ x: c, y: g });
                b = Z;
            ...
            function Ej(a, b) {
                ...
                for (g = 0; g < f[X]; g++)
                    if (((e = f[g]), (j = w[Vb](e.elementId)), !(e.elementId == k || e.isStatic == h || Ig(j) == h))) {
                        xj(j);
            ...
            function nf(a) {
                ...
                if (Ng(a) == h) return (a = of(w[Vb](a))), a == k ? nf(k) : nf(a?.id);
                a = M[a];
                var b = Wa(ka(a));
            ...
            function Og(a) {
                if (Lg(a) == k) {
                    ...
                    b.Vb = 0;
                    b.Va = 0;
                    var c = B.Engine[Ha]({ vc: h });
                    b.oa = c;
                    if (v.HYPE_DEBUG_PHYSICS == h) {
                        var d = { element: w[Vb](a), engine: c },
                            d = B.Render[Ha](d);
                        b.Wb = d;
                    }
                    var d = mf(a),
                        e = nf(a);
                    a = lf(a);
                    c.world.gravity.x = d * B.Common.cos((e * r.PI) / 180);
            ...
            function Cj(a, b, c) {
                var d = a[0],
                    ...
                    f = a[2],
                    g = a[3];
                return [d + f * r.tan(c), e + g * r.tan(c), d * r.tan(b) + f, e * r.tan(b) + g, a[4], a[5]];
            }
            function ne(a, b, c) {
                var d = a[0],
                    e = a[1],
            ...
            function ud(a) {
                ...
                if (c != Z && f != Z) {
                    ...
                    if (d == Qo || d == Ro || d == So) {
                        ...
                        f[Y](on, Z + a);
                        f[Eb](Lo);
                    } else c[Y](dq, Wf), c[Y](on, Wf), c[Y](Bo, qo), c[Y](Zp, Rf + j + $ + a), c[Y](Lo, gq), c[Eb](Ao), f[Y](m + qn, g), f[Y](dq, Z + j), f[Y](on, Z + a), f[Y](Lo, gq);
                }
                b[Y](bn, e);
            }
            function db(a) {
                ...
                b[Y](rp, g);
                b[Y](cn, j);
                0 == m ? (1e-4 > r.abs(1 - l) ? (u = t = q = 0) : ((c = b.getTotalLength()), 0 == l && (c = r[Cb](c)), (t = q = c), (u = c - c * l))) : (0.3 > q && (q = 0), 0.3 > t && (t = 0));
                ...
                if (b && c) {
                    ...
                    if (1 == e) {
                        ...
                        for (m = 0; m < j[X]; m++) {
                            ...
                            D = C - 1;
                            for (N = T - 1; 0 < D || 0 < N;)
                                0 < D && 0 < N && O[D][N] == O[D - 1][N - 1] + Lj(x[D], y[N], s) ? (q[vb](x[D--]), t[vb](y[N--])) : 0 < D && O[D][N] == O[D - 1][N] + 0 ? (q[vb](x[D--]), t[vb](Mj())) : (q[vb](Mj()), t[vb](y[N--]));
                            s = O[C - 1][T - 1];
                            u = u.copy();
                            l = l.copy();
                            u.ba = q;
            ...
            function Qg(a) {
                return { aa: Oa(a.aa), ha: Oa(a.ha), la: Oa(a.la), nb: a.nb };
            }
            function Kb(a, b, c) {
                return { aa: Oa(a), ha: Oa(b), la: Oa(c), nb: p };
            }
            function Mj() {
                var a = E(0, 0);
                return { aa: Oa(a), ha: Oa(a), la: Oa(a), nb: h };
            }
            function Dj(a) {
                for (var b = [], c = 0; c < a[ic][X]; c++) {
                    var d = a[ic][c];
                    b[z]({ sa: { x: d[0], y: d[1] }, La: { x: d[2], y: d[3] }, Ha: { x: d[4], y: d[5] }, Ia: { x: d[6], y: d[7] }, length: 0, ea: [] });
                }
                qf(b, p, 2, 20, h);
                a = [];
                for (c = 0; c < b[X]; c++) for (var d = b[c].ea, e = 0; e < d[X]; e++) a[z](d[e][Ma]);
                return a;
            }
            function Jj(a) {
                var b = a[ic];
            ...
            function Ij(a) {
                var b = [],
                    c = a[ic];
                if (c) for (var d = 0; d < c[X]; d++) b[z](c[d][tb](0));
                return { path: b, closed: a[Qa] };
            }
            function Rg(a, b, c, d) {
                var e = [];
                Xa(e, 0, a);
            ...
            function Rj(a, b, c) {
                if (pe != k) {
                    var d = { element: a, triggerOnce: p, elementOffset: 0 };
                    d[c] = function () {
                        Ab({ type: ii + (c == Tm ? Ch : Eh) + Ni }, a);
                        b();
                    };
                    d = new pe.hypeS(d);
                    rf[z](d);
            ...
            function ia(a, b) {
                return function (c) {
                    for (var d = 0; d < b[X]; d++) {
                        ...
                        if (1 == f) vd(Sj(e.e, e.f), e.g, e.d);
                        else if (3 == f) e?.b != k && ((f = e.z != ba ? e.z : p), Lb(e?.b, a != k ? a?.id : k, f));
                            ...
                            (f = Tj(e.j)),
                                f != k &&
                                ((e = e.k == h),
                                    (e = 9 > F.$ ? e || 4 == c[wb] : e || 1 == c[wb] || c.metaKey == h)
                                        ? 9 > F.$ || (F.$ != k && F.Yb) || F.Xa != k
                                            ? v.open(f, Ri)
                                            : (9 == F.$ || 15 > F[bc]) && !(c instanceof MouseEvent)
                                                ? v.open(f, Ri)
                                                : ((e = w[Sc](Vi)),
                                                    e[Y](qn, f),
                                                    e[Y](Ap, Ri),
                                                    w[yb][Fb](e),
                                                    (f = w.createEvent(zi)),
                                                    f.initMouseEvent(dm, c.bubbles, c.cancelable, c.view, c.detail, c.screenX, c.screenY, c[Rb], c[Sb], c[Ub], c.altKey, c.shiftKey, c.metaKey, c[wb], w[yb][dc]),
                                                    e.dispatchEvent(f),
                                                    w[yb][Cc](e))
                                        : (v.top.location = f));
                        else if (6 == f) {
            ...
            function Sj(a, b) {
                ...
                if (b == k || 0 == b)
                    a: {
                        for (c = 0; c < Va[X]; c++) if (Va[c].o == a) break a;
                        c = -1;
                    }
            ...
            function re(a) {
                if (1 == n(a, kn, 0)) Xg(a);
                    ...
                    var b = n(a, Gi),
                        ...
                        f = n(a, kn, 0);
                    if (!(b == k || c == k || d == k || e == k))
                        for (var g = [ca.wa + Dl, Ai, El, Dl], j = 0 == b && 0 == c && 0 == e, b = (2 == f ? Gn : Z) + K(b) + $ + K(c) + $ + K(e) + $ + eb(d), c = 0; c < g[X]; c++)
                            j == h ? (a[H][Eb] ? a[H][Eb](g[c]) : a[H].removeProperty(g[c])) : (a[H][g[c]] = b);
                }
            }
            function se(a) {
                var b = n(a, Uh, Z),
            ...
            function zd(a) {
                ...
                if (s == k) {
                    ...
                    for (na = M[a?.id]; na != k && O[na] != k;)
                        if (((na = O[na].bF), na != k && O[na] != k && (O[na].cQ != k || O[na].cR != k || (Jc == h && 0 != (O[na].bS & 256))))) {
                            s = h;
                            break;
                        }
                    V(a, ci, s);
            ...
            function Lc(a) {
                try {
                    if (kf == h) -1 == Ia(te, a) && te[z](a);
                        ...
                        if (Jc == h && 36 != b) {
                            ...
                            if ((Q == h || U == h) == h)
                                (g = T),
                                    ...
                                    (S = D / x),
                                    (P = l),
                                    Q == h ? (P = l <= S ? l : S) : U == h && (P = l >= S ? l : S),
                                    (T = r[Cb](s * P)),
                                    (D = r[Cb](x * P)),
                                    (Q = g - T),
                                    (U = f - D),
                                    O == h && na == p ? (j += Q) : O == h && na == h && (j += r[Cb](Q / 2)),
                                    B == h && J == p ? (C += U) : B == h && J == h && (C += r[Cb](U / 2));
                        }
                        var R = r.max(0, T - (s - q)),
                            W = r.max(0, D - y),
                            y = p;
                        ...
                        V(a, Oh, C);
                        V(a, Ph, j);
                        c == p && ((C += n(a, Wh, 0)), (j += n(a, Vh, 0)), (a[H].top = K(C)), Ba(a[H], K(j)));
            ...
            function Ia(a, b) {
                if (a[$b]) return a[$b](b);
                for (var c = 0; c < a[X]; c++) if (a[c] == b) return c;
                return -1;
            }
            function ak(a) {
                            ...
                            for (f = x = C = 0; f < q.va[X]; f++) {
                                ...
                                if (0 == f)
                                    var C = nb(d),
                                        ...
                                        C = aa[d].a + C / 2 - y.sa.x,
                                        x = T + x / 2 - y.sa.y;
                                t[z]({ sa: { x: y.sa.x + C, y: y.sa.y + x }, La: { x: y.La.x + C, y: y.La.y + x }, Ha: { x: y.Ha.x, y: y.Ha.y }, Ia: { x: y.Ia.x, y: y.Ia.y }, length: 0, ea: [] });
                                x = C = 0;
                            }
                            a.va = t;
                            xa(a, qf(a.va, h));
            ...
            function ck(a, b, c) {
                ...
                if (0 > b || 1 < b) {
                    ...
                    } else (m = -1), (l = 1 - b), (q = a.va[a.va[X] - 1]), 2 <= q.ea[X] && ((f = q.ea[q.ea[X] - 2]), (j = e = q.ea[q.ea[X] - 1]));
                    if (f != k && e != k) {
                        a = m * (e[Ma].x - f[Ma].x);
                        b = m * (e[Ma].y - f[Ma].y);
                        d *= l;
                ...
                } else if (0 == d) g = { x: a.va[0].sa.x, y: a.va[0].sa.y, Ra: 0 };
                else {
            ...
            function ch(a, b, c) {
                ...
                c = [];
                for (d = 0; d < b.qa[X]; d++)
                    (g = b.qa[d]), (f = Ob(g, b)), (f = Da(f + g.d, b)), a < f ? (g.i == Vi || g.i == Yk ? c[z](g) : bk(g, a, b)) : ((f = ka(g.o)), (e = b.da == h ? g.b : k), W(f, g.i, e == k ? (b.da ? g.s : g.e) : e), b.qa[bb](d, 1), d--);
                ...
                if (g != k && 0 != g[X]) {
                    ...
                    for (d = b.Pa; d < g[X]; d++)
                        if (((m = g[d]), (e = m.b), (j = la(e)), j != k && ((f = j.pa.q), (l = f == p ? m[cc] : 86400), (f = b.da == p ? m[mb] : Da(c - m[mb] - l, b)), a >= f))) {
                            b.Pa = d + 1;
                            var q = m.z,
                                t = m.E,
                                n = t,
                    ...
                    for (var q = (d = 0), n = b.fa, s = b.da, l = 0; l < j[X]; l++) {
                        ...
                        if (!(c == p && t != m)) {
                            ...
                            if (0 != y[X]) {
                                ...
                                ia(O, y)({ type: si, timelineName: b.pa.n });
                            }
                            if (f != b.ia || b.ia == k || n != b.fa || C || s != b.da) (e = h), (d = t);
                        }
                    }
                    e == p && ch(m, b, g);
                }
                    ...
                    if (!(e.ia == k || e.fa == p || e.Ja == h)) {
                        ...
                        if (e.fa != p) {
                            ...
                            if (f * e.ja <= j) {
                                ...
                                g = e.da == p ? e.fb : e.sb;
                                if (0 < e.ya[X]) a = 0;
                                else if (e.Pa < g[X] && ((g = g[e.Pa]), (g = Da(((e.da == p ? g[mb] : Da(j - g[mb] - g[cc], e)) - f * e.ja) / e.ja, e)), g < a || a == k)) a = g;
                            }
                        }
                    }
                }
                    ...
                    for (d = 0; d < Ea[X]; d++)
                        if (((j = Ea[d]), (e = la(j.ca)), e != k && e.fa == h)) {
                            ...
                            for (var f = r.max(0, c - e.ia), g = j, m = B.Composite.allBodies(g.oa.world), l = p, q = 0; q < m[X]; q++) {
                                ...
                                if (-1 == x) {
                                    2 == s && Ig(u) == p && t.Ga != k
                                        ? ((t = u), (x = zb(t)), (s = x.oa.world), (t = x.Qa[M[t?.id]]), t.Ga != k && (B.World.remove(s, t.Ga), delete t.Ga), mc(u, h))
                                        : 1 == s && Ig(u) == p && (B.Body.setVelocity(t, { x: 0, y: 0 }), B.Body.setAngularVelocity(t, 0));
                                    ...
                                    2 == s &&
                                        ((t = u),
                                            ...
                                            (t = x.Qa[M[t?.id]]),
                                            t.Ga == k &&
                                            ((x = B.Constraint[Ha]({ pointA: E(t[Wb].x, t[Wb].y), bodyB: t, length: 0.01, stiffness: 1, angularStiffness: 1, render: { strokeStyle: od, lineWidth: 3 } })), B.World.add(s, x), (t.Ga = x)));
                            ...
                            Ej(j, f);
                            a: {
                                f = B.Composite.allBodies(j.oa.world);
                                for (j = 0; j < f[X]; j++)
                                    if (f[j].isSleeping == p) {
                                        f = p;
                                        break a;
            ...
            function Xb(a, b, c, d) {
                ...
                if (e != k)
                    return (
                        ue(e, 1),
                        -1 == Ia(Pb, e) && (Mb(b), Pb[z](e)),
                        (b = Ca(e)),
                        a > b && (a = e.pa.q == h ? r.max(0, a - r[Ec](a / b) * b) : b),
                        e.da == h && (a = b - a),
                        d == h && (a = Da(a, e)),
                        (e.Ca = 0),
                        (e.Pa = 0),
                    ...
                    (c && ue(e, 1),
                        ...
                        (e.ia != k
                            ? e.na == Ca(e)
                                ? d && Lb(a, k, b)
                                : ((e.fa = h),
                                    (e.ia = Bb(ba) / 1e3 - e.na / e.ja),
                                    v[Sa](e.Da),
                                    (e.Da = v[fc](function () {
                                        Ed(e);
                                    }, 1e3 * ((Ca(e) - e.na) / e.ja))),
                                    e.Ja != h && (eh(e, e.na), (e.Ca = 0), (e.Pa = 0), (e.qa = []), (e.ya = [])),
                                    Mc(e.na / e.ja, e, p, p))
                            : (d == h || 0 == e.na) && Lb(a, k, b)),
                        rd());
            }
            function Mb(a, b, c) {
                for (var d in Bd) Bd[I](d) != p && Bd[d] == a && Mb(d, k);
                Af(a);
                a = la(a);
            ...
            function Ed(a) {
                if (!(fa == h && a.Ja == h) && ((a.ja = 1), !Mc(Ca(a), a, h, h)))
                    ...
                    else if (((a = { type: ti, timelineName: a.pa.n }), Ab(a, k) !== p)) {
                        var b = va();
                        if (b != k) {
                            var c = A[Cf(Oc(U))].F;
                            c != k && ia(b, c.a)(a);
            ...
            function Ca(a) {
                return fa == h && a.Ja == h ? 86400 : Da(a.pa.d, a);
            }
            function rd() {
                if (zf !== h) {
                    zf = h;
            ...
            function jk(a) {
                for (var b = 0; b < Pb[X]; b++) {
                    var c = Pb[b];
                    if (!(a != k && c.ca == a.ca)) for (var d = 0; d < c.qa[X]; d++) rb[c.qa[d].o][c.qa[d].i] != c.ca && (c.qa[bb](d, 1), d--);
                }
            }
            function eh(a, b) {
            ...
            function Lb(a, b, c) {
                ...
                if (f != k)
                    if (((f.sc = b), Pb[z](f), A[U].T[f.ca] == k && f.Ab == ba && f.Ja != h)) Ed(f);
                        ...
                        ((a = c == p),
                            f.Ja != h && (dh(f, a), Cd(f, c), eh(f, 0), ik(f, 0)),
                            (f.fa = h),
                            (f.Ca = 0),
                            (f.Pa = 0),
                            (f.qa = []),
            ...
            function la(a) {
                ...
                for (var d in ha) if (ha[I](d) != p) for (var e = ha[d].Hb, b = 0; b < e[X]; b++) if (((c = e[b]), c.ca == a)) return c;
                return k;
            }
            function qc(a) {
                var b = A[U].T,
            ...
            function we(a, b, c, d) {
                b = { Ca: 0, qa: [], ra: b, ca: a, fb: c.b, fa: p, na: 0, ja: 1, da: p, ya: [], Ab: d, pa: c, rb: {} };
            ...
            function Vj(a, b, c) {
                ...
                if (d != k) {
                    ...
                    for (a = 0; a < d[X]; a++) (f = d[a]), f.o == c && ((b = f.i), (f = f.e), f != k && ((g = fh[c]), g == k && ((g = {}), (fh[c] = g)), g[b] == k && (g[b] = aa[c][b]), W(e, b, f)));
                }
            }
            function W(a) {
            ...
            function oe(a) {
                ...
                if (0 == a[$b](Uo)) {
                    ...
                    a[Hc](0) == md && (a = a[tb](1));
                    a = a.toUpperCase();
                    for (var d = 3 == a[X] ? 0 : 1, e = ca.xb, c = 0; 3 > c; c++) b[c] = 16 * e[$b](a[Hc](c * (1 + d))) + e[$b](a[Hc](c * (1 + d) + d));
                }
                return b;
            }
            function bh(a) {
            ...
            function gh(a, b, c, d) {
                ...
                aa[M[a?.id]] && a != k && a != b && (a?.[Y]?.(Rk, h), W(a, ml, 0, mj, 0, Yk, 0, Vi, 0, iq, 0, Nm, 1), V(a, $h, cf));
                S[H][Se] = k;
                S[H][ca.wa + Lp] = en;
                S[H][Ke] = k;
                S[H].perspective = k;
                ...
                if (d == h) {
                    ...
                    c = Wa(b);
                    b = hh(b);
                    for (d = 0; d < b[X]; d++) if (((f = b[d]), (a = w[Vb](f)), (f = A[c].v[M[f]]), f != k)) for (e = 0; e < Ff[X]; e++) (j = Ff[e]), f[I](j) != p && W(a, j, f[j]);
                }
            }
            function pk(a, b, c, d) {
                var e = ha[b][Bc];
            ...
            function rk(a, b) {
                ...
                if (fa == h) {
                    Eg();
                    for (c = 0; c < Ea[X]; c++) (d = Ea[c]), d.ca == k && ((e = d), (f = Jn + e[wc]), (e.ca = f), (d = k), Mg(e) == h && (d = M[e[wc]]), (e = { Ja: h, ra: [], ca: f, qc: e, Ab: d }), d != k ? ha[d].Hb[z](e) : sb[z](e));
                    c = function () {
            ...
            function qk(a, b, c, d) {
                if (n(b, hi, p) != h) {
                    ...
                    F.$ != k && a.bE == k && (b[H].behavior = Rp + Pc(Ee) + Rd);
                }
            }
            function rq() {
                ye[bb](0, 1);
            ...
            function Uj(a) {
                var b = { type: ui, customBehaviorName: a },
                    c = If[a];
                if (c != k) for (var d = 0; d < c[X]; d++) c[d](b);
                for (var e in ha) ha[I](e) != p && ((c = ha[e].Ob[a]), c != k && c(b));
                Ab(b, k);
            }
            function uk(a, b, c) {
                c ? (ha[c].Ob[a] = b) : ((c = If[a]), c == k && ((c = []), (If[a] = c)), c[z](b));
            }
            function ih(a, b, c, d) {
                function e(a) {
                    a = a ? a : v[Qb];
                ...
                function f(a) {
                    ...
                    } else a[La] == Jp ? 0 < a[gc][X] && Gf(a[gc][0]) : a[La] == Hp && 0 < a[ec][X] && Gf(a[ec][0]);
            ...
            function Qc(a, b, c) {
                c = { Aa: k, Ka: Sm, Ya: 0, Sa: k, lb: 0, Ib: 0, yb: 0, Xb: 0, Sb: 0, Tb: 0, Kb: k, Jb: k, ta: k, ma: p, wb: p, options: b, Lb: c, Ma: a };
                Ya(Jp, vk(c), a, h);
                if (b.ka == Lm || b.ka == vp) {
                    var d = a == w ? S : a,
                        e = d[H].touchAction;
            ...
            function tq(a) {
                ...
                function c(b, c, d) {
                    ...
                    return { o: f, size: c, sE: l, cI: b, Rb: d };
                }
                function d(a, b, c) {
                    return {
                        i: Ag,
                ...
                return { b: n, c: g, A: 0 == g ? 0 : 1, y: h, K: 1.5 * (j / 2), p: a?.p };
            }
            function wk(a, b) {
                for (var c = { Ta: 1, gc: h, ka: Lm }, d = b.a, e = h, f = 0; f < d[X]; f++) {
                    var g = d[f],
                        j = g.p;
                    0 != j && (e = p);
                    10 == j && g.b != k ? (c.ga == k && (c.ga = []), c.ga[z]({ b: g.b, c: g?.c, A: g.A, y: g.y, K: 100 / g.K })) : 11 == j ? (c.za = a) : 16 == j && (c.Za == k && (c.Za = []), c.Za[z](g));
                }
                e == p && Qc(a, c, ia(a, d));
            }
            function vk(a) {
                return function (b) {
                    ...
                    if (a.ma == p || 1 === a.Ya) {
                        ...
                        a.Aa = k;
                        c = [];
                        for (d = 0; 5 >= d; d++) c[z]({ start: { x: 0, y: 0 }, end: { x: 0, y: 0 }, lastPosition: { x: 0, y: 0 } });
                        a.Sa = c;
                        a.Ua = ba;
                        a.wb = p;
                        var c = a.ma ? b[gc][0] : b,
                        ...
                        a.ma
                            ...
                            Ya(
                                Yn,
                                function (a) {
                                    (a.relatedTarget === w.documentElement || a.toElement === k) && e(a);
                                },
                                b,
                                p
                            );
                                ...
                                if (Kf == h) a.ta(b);
                                    ...
                                    if ((a.mb == p) == h) {
                                        ...
                                        if (c.Za != k) {
                                            ...
                                            if (d) for (e = 0; e < c.Za[X]; e++) if (((d = c.Za[e]), (0 != d?.c || a.gb == p) && (1 != d?.c || a.hb == p))) (d = tq(d)), c.ga[z](d);
                                        }
                                        if (c.ka == Lm) {
                                            Ae == h && a.ta(b);
                                            a.Ma != w && (Ae = h);
                                            ...
                                            c.za != k &&
                                                ((e = M[c.za?.id]),
                                                    (a.Sb = n(c.za, Ph, aa[e].a)),
                                                    (a.Tb = n(c.za, Oh, aa[e].b)),
                                                    rb[e] != ba && ((rb[e].a = k), (rb[e].b = k), jk(k)),
                                                    cb[e] === ba && (cb[e] = {}),
                                                    (cb[e].a = Pm),
                                                    (cb[e].b = Pm),
                                                    fa == h && mc(c.za));
                                    ...
                                    if (c.ka == Lm) {
                                        ...
                                        if (c.ga != k) {
                                            for (var N = c.ga, N = [], O = 5 <= pb(y.end, y[zc]), e = 0; e < c.ga[X]; e++) {
                                                l = c.ga[e];
                                                if (16 == l.p && a.qb == p)
                                                    if (O == p) continue;
                                        ...
                                        c.za != k &&
                                            ((e = M[c.za?.id]),
                                                (A = a.Sb + (y.end.x - y[zc].x) / C),
                                                (y = a.Tb + (y.end.y - y[zc].y) / T),
                                                Jc == p
                                                    ? ((D = Hg(D)), (T = nb(e)), (A = r.max(A, -T / 2 - x)), (A = r.min(A, D[G] - T / 2 - x)), (e = ob(e)), (y = r.max(y, -e / 2 - s)), (y = r.min(y, D[L] - e / 2 - s)))
                                                    : ((D = Aj(c.za, A, y)), (A = D.x), (y = D.y)),
                                                (c = c.za),
                                                W(c, Vi, A, Yk, y),
                                                fa == h && (Jg(c, Vi, A, u / 1e3), Jg(c, Yk, y, u / 1e3), V(c, Kl, h), (c = zb(c)), le(c)));
                                        Mf(b, a);
                                    } else
                                        c.ka == vp
                                            ? 1 < a.Ya
                                                ? a.ta(b)
                                                : (b[gb] && a.Aa == c[Dc] && b[gb](),
                                                    (A = c[Dc] == Yo || c[Dc] == On ? y.end.x : y.end.y),
                                                    (D = p),
                                                    (D = c[Dc] == Yo || c[Dc] == Km ? 20 < a.Ua - A : 20 < A - a.Ua),
                                                    (c = a.Aa === c[Dc] || 100 > u),
                                                    (D || c == p || Ae == h) && a.ta(b))
                                            : c.ka == zp && 5 < pb(y[zc], y.end) && a.ta(b);
                                    xk(a, d);
                                }
                        };
                            ...
                            if (!(a.Ka === Sm || a.Ka === am) && !(b[gc] && 0 < b[gc][X])) {
                                ...
                                if ((Kf == h && 0 < Jf) || c == p) a.ta(b);
                                    ...
                                    if (c.ka == Lm) {
                                            ...
                                            for (n = 0; n < c.ga[X]; n++) {
                                                ...
                                                if (q) {
                                                    var x = Ca(q),
                                                        ...
                                                        N = 1;
                                                    if (s == h)
                                                        if (((s = 0), (s = 0 == u?.c ? r.abs(e[Ga].x - e.end.x) / d : r.abs(e[Ga].y - e.end.y) / d), (s *= 2), 20 < s))
                                                            (A = h), (D = u), (N = Ak(e[Ga], e.end)), (D = (0 == D?.c ? (90 <= N || -90 >= N ? On : Yo) : 0 >= N && -180 <= N ? Pp : Km) != y), (N = s / C);
                                                        else {
                                                            C = y = Nc(q.ca, p);
                                                    ...
                                                    Cd(q, D);
                                                    ue(q, N);
                                                    A == h && q.na != x ? wd(l, D, p, p) : Xb(D ? x - q.na : q.na, l, h, h);
                                                }
                                            }
                                        }
                                        Mf(b, a);
                                        ...
                                        c.ka == vp
                                            ? ((l = a.Aa === c[Dc]), (d = d && n && l), (e = pb(e[zc], e.end)), d && e > c.ib ? ((b = { type: pi + c[Dc][Hc](0).toUpperCase() + c[Dc][tb](1) + zg }), a.Lb(b)) : a.ta(b))
                                            : c.ka == zp
                                                ? 1500 > q && a.Lb(b)
                                                : a.ta(b);
                                    kh(a);
            ...
            function Ya(a, b, c, d) {
                var e = Jb(c);
                e != k && (c = e);
                e = { eventType: a, handler: b, element: c };
                d && Nf[z](e);
                c[ab] ? c[ab](a, b, F.Gb ? { passive: p } : p) : c[Tb] && c[Tb](so + a, b);
                Xj(c);
            }
            function Hf(a) {
                var b = {};
                ...
                if (1 == c)
                    ...
                    2 == c &&
                        ((c = function () {
                            ...
                            (d = Tg(Na[a].g)),
                            (F.Na != k && 536.26 > F.xa) || 9 > F.$ ? v[fc](c, 1) : d.load(c, c));
            }
            function Ek() {
                df != k && df(p, S);
                if (Ab({ type: ji }, S) !== p)
            ...
            function Cf(a) {
                for (var b = 0; b < A[X]; b++) if (A[b].o == a) return b;
                return -1;
            }
            function Oc(a) {
                a = A[a];
            ...
            function fb(a, b, c, d, e, f, g, j, m) {
                a[z]({ i: b, t: c, d: d, f: e, o: f, s: g, e: j, r: m, p: 0 });
            }
            function nh(a, b, c, d, e) {
                b = { i: a, n: a, f: 30, d: b, a: c, b: [] };
                S[Y](Qk, h);
                S[Y](Rk, h);
                A[U].T[a] = b;
                we(a, c, b);
            ...
            function Pf(a, b, c, d) {
                if (!(Oc(a) == k || Ef == h)) {
                    ...
                    var e = function () {
                        ...
                        for (var E in B)
                            if (B?.[I]?.(E) != p && (u = A?.[n]?.[E])) {
                                ...
                                f == p && ((u = ia(va(), u)), Qc(q, { Ta: 1, direction: B[E], ib: 30, ka: vp }, u));
                            }
                        (E = A?.[n]?.K) && wk(w, E);
                        E = va();
                        if (2 == b) {
                            ...
                            e != k &&
                                ((K = M[e?.id]),
                                    ...
                                    (Q = sc(P)),
                                    (P = tc(P)),
                                    f(e, iq, 1, ml, 0, Hl, Q, im, P),
                                    u(s, Vi, 0, j, im, K, 0, q),
                                    u(s, ml, 0, j, im, K, 0, -300),
                                    u(s, mj, 0, j, im, K, 0, -20),
                                    u(s, iq, 0, j, Vi, K, 1, 0));
                            var R = M[E?.id];
                            V(E, $h, Wf);
                            u(s, Vi, 0, j, im, R, n, l);
                            ...
                            f(E, Vi, g, ml, -600, mj, 50, iq, 0, Hl, m, im, t);
                            nh(Zh, B, s, e, E);
                            qa(E[H], yl);
                        } else
                            4 == b || 5 == b || 6 == b || 7 == b
                                ? ((K = c),
                                    ...
                                    (f = tc(f)),
                                    5 == b || 4 == b
                                        ? (Gd(e, E, p, h), P != B && (fb(Q, Hl, 0, K, Hl, J, P, B), (aa[J] = {}), (aa[J].c = P), (aa[J].d = u > f ? u : f), (aa[J].a = 0), (aa[J].b = 0)))
                                        : (Gd(e, E, h, p), u != f && (fb(Q, im, 0, K, Hl, J, u, f), (aa[J] = {}), (aa[J].c = P > B ? P : B), (aa[J].d = u), (aa[J].a = 0), (aa[J].b = 0))),
                                    (g = Vi),
                                    (q = B),
                                    (n = -1 * B),
                                    5 == b ? ((q = -1 * P), (n = P)) : 6 == b ? ((g = Yk), (q = -1 * u), (n = u)) : 7 == b && ((g = Yk), (q = f), (n = -1 * f)),
                                    e != k && ((l = M[e?.id]), W(e, Hl, P, im, u), fb(Q, g, 0, K, Hl, l, 0, q)),
                                    fb(Q, g, 0, K, Hl, M[E?.id], n, 0),
                                    W(E, Hl, B, im, f, g, n),
                                    nh(Yh, K, Q, e, E),
                                    qa(E[H], yl))
                                : (Gd(e, E, p, p), gh(e, E, k, h));
                        rc();
                    },
                        f = p,
                        g = va();
                    ...
                    if (Hk == h && g != k) {
                        ...
                        j = Fd(va());
                        for (m = 0; m < j[X]; m++) (l = j[m]), sd(l) != p && !A[g].v[M[l?.id]].cL && ((q = { type: ri }), Ab(q, l), (t = n(l, Ll)) && ia(l, t.a)(q));
                        for (var s in Jd) Jd[I](s) != p && (w[Rc] ? w[Rc](s, Jd[s], p) : w[Pa] && w[Pa](so + s, Jd[s]));
                        Jd = {};
                        for (m = 0; m < Nf[X]; m++) (s = Nf[m]), Be(s.eventType, s.handler, s[Bc]);
                        Nf = [];
                    }
                    Hk = h;
                    f == p && e();
            ...
            function oh(a) {
                for (var b = [], c = 0; c < a.X[X]; c++) {
                    var d = a.X[c],
                        e = A[d];
                    b[z]({ _: d, name: e.n, breakpoint: e.d, width: e.Y, height: e.Z });
                }
                return b;
            }
            function Ik(a, b) {
                for (var c = oh(b), d = 0; d < c[X]; d++) if (c[d].name == a) return c[d]._;
                return -1;
            }
            function ph() {
            ...
            function Ab(a, b) {
                ...
                if (c != k) {
                    for (var d, e = 0; e < c[X]; e++) if (c[e][La] == a[La] && c[e].callback != k && ((d = c[e].callback(ca.API, b, a)), d === p)) return p;
                    return d;
                }
            }
            function Jk(a) {
            ...
            function vq() {
                for (var a in qh) qh[I](a) != p && (pd[a] = { q: qh[a] });
                for (var b in pd)
                    if (pd[I](b) != p)
                        if (((a = pd[b].q), typeof a === lp)) Ad[b] = eval(a);
                            ...
                            for (var c = [], d = 0; d < a[X]; d++) {
                                var e = a[d];
                                c[z]({ sa: { x: e[0], y: e[1] }, La: { x: e[2], y: e[3] }, Ha: { x: e[4], y: e[5] }, Ia: { x: e[6], y: e[7] }, length: 0, ea: [] });
                            }
                            qf(c, p);
                            Ad[b] = c;
                        }
            ...
            function Kd(a, b, c) {
                return { x: a.x + (b.x - a.x) * c, y: a.y + (b.y - a.y) * c, Ra: 0 };
            }
            function pb(a, b) {
            ...
            function jh(a) {
                ...
                if (1 != b[X]) {
                    var d = S[yc][Hb];
                    if (0 != d) for (var e = 0; e < b[X] && !(b[e].breakpoint > d); e++) c = b[e]._;
                }
                b = A?.[c]?.n;
                d = Ab({ type: ki, layoutName: b, sceneName: a.n }, S);
            ...
            function Hg(a) {
                ...
                a != k && (b = Yb[a]);
                a = Kc[b];
                a == k && ((a = w[Vb](b)), (a = { width: a[Hb], height: a.offsetHeight }), (Kc[b] = a));
                return a;
            }
            function hf(a) {
                var b = 0,
                    c = 0;
                a == k ? ((b = w[Vb](Yb[a])), (a = Wa(b)), (b = A[a].Y), (c = A[a].Z)) : ((b = nb(a)), (c = ob(a)));
            ...
            function th() {
                for (var a = Z, b = ca.xb + Hh, c = 0; 20 > c; c++) var d = r[Ec](r.random() * b[X]), a = a + b.substring(d, d + 1);
                return a;
            }
            function qe(_a) {
            ...
            function Bk(a) {
                ...
                ra(b, function () {
                    b.Mb();
                    var a = v.HYPE_gac_754;
                    a == k && ((a = new (v.AudioContext || v.webkitAudioContext)()), (v.HYPE_gac_754 = a));
                    a.resume != k && a.resume();
                    ...
                    b.Ba != h
                        ? ((b.$a = h), b.load())
                        : b.Cb != k
                            ? (a.decodeAudioData(b.Cb, function (a) {
                                b.ec = a;
                                b[Ac].buffer = a;
                                b[xc].Fb != h && b.ub();
                            }),
                                (b.Cb = k))
                            : ((b[Ac].buffer = b.ec), b[xc].Fb != h && b.ub());
                });
                ya(b, function () {
                    b.Ba != h ? (b.$a = p) : b.Mb();
                });
            ...
            var ca = this,
                ...
                ok = {
                    "physics-body-type": { HYP_r: il },
                    "physics-bounce": { HYP_r: ql, HYP_s: 0.5 },
                    "physics-friction": { HYP_r: rl, HYP_s: 0.1 },
                    "physics-air-drag": { HYP_r: Vl, HYP_s: 0.01 },
                    "physics-density": { HYP_r: sl, HYP_s: 0.001 },
                    top: { HYP_r: Yk },
                    left: { HYP_r: Vi },
                    width: { HYP_r: Hl },
                    height: { HYP_r: im },
                    "background-image": { HYP_x: h, HYP_r: $l },
                    rotateZ: { HYP_r: Ym, HYP_s: 0 },
                    scaleX: { HYP_r: Tl, HYP_s: 1 },
                    scaleY: { HYP_r: Ul, HYP_s: 1 },
                    "z-index": { HYP_r: iq },
                    opacity: { HYP_r: Nm, HYP_s: 1 },
                },
                qb = 0,
                U = 0,
                sb = [],
                ...
                Kc = {},
                If = {},
                qh = { d: [[0, 0, 0.42, 0, 1, 1, 1, 1]], e: [[0, 0, 0, 0, 0.58, 1, 1, 1]], c: [[0, 0, 0.42, 0, 0.58, 1, 1, 1]] },
                Id = p,
                rh = p,
                pe = v.HYPE_w_754,
                rf = [],
            ...
            ca.z_o = function () {
                ...
                df != k && df(h, S);
                ef = ef && F.xa != k;
                F.Na != k && w[yb][ab](Ip, lq(), F.Gb ? { passive: p } : p);
                Yb[J] = J;
                M[J] = J;
                uh[J] = J;
                for (var a = 0; a < A[X]; a++) {
                ...
                Kk(Xe);
                nq == h && Kk(Qi);
                for (a = 0; a < sj[X]; a++) (b = sj[a]), (c = w[Sc](Jm)), za(c, b), Jk(c), 9 > F.$ && ((b = b.match(/('|")(http.*?css.*?)('|")/)), b != k && 2 <= b[X] && w.createStyleSheet(b[2]));
                v[fc](rc, 120);
                v[fc](rc, 1200);
                a = w[Sc](Jm);
                a.id = Lh;
                ...
                for (b = 0; b < A[X]; b++) {
                    ...
                    for (j in e)
                        if (e[I](j) != p && ((f = e[j]), (g = f.cL) && ha[g] == k)) {
                            ...
                            ha[g] = { element: m, Hb: l, kc: f.cS, Ub: p, Ob: [] };
                        }
                    l = c.O;
                    for (u = 0; u < l[X]; u++)
                        ...
                        if (q[I](x) != p) {
                            ...
                            for (var y in s)
                                if (s[I](y) != p) {
                                    ...
                                    b = {};
                                    c = [];
                                    for (d = 0; d < a[X]; d++) (e = a[d]), c[z]({ sa: { x: e[0], y: e[1] }, La: { x: e[2], y: e[3] }, Ha: { x: e[4], y: e[5] }, Ia: { x: e[6], y: e[7] }, length: 0, ea: [] });
                                    b.va = c;
                                    xa(b, qf(c, h));
                                    ah[y] = b;
                                }
                ...
                if (fa == h) {
                    ...
                    "undefined" === typeof w[ab] ||
                        "undefined" === typeof w?.[C] ||
                        w[ab](
                            B,
                            function () {
                                if (w?.[C])
                                ...
                                else for (a = 0; a < Ea[X]; a++) (b = Ea[a]), b.ca != k && wd(b.ca);
                            },
                            p
                        );
                }
            ...
            if (ja) {
                ...
                Q.Wa == k &&
                    ((Q.$ = da($a(/MSIE (\d+\.\d+)/)) || da($a(/(Trident)/) && $a(/rv:(\d+\.\d+)/)) || da($a(/Edge\/(\d+\.\d+)/)) || k),
                        (Q.lc = da($a(/Gecko\/(\d+)/)) || k),
                        (Q.Xa = da($a(/Firefox\/(\d+\.\d+)/)) || k),
                        (Q.xa = da(!Q.$ && $a(/AppleWebKit\/(\d+\.\d+)/)) || k),
                        (Q.Wa = da(Q.xa && $a(/Chrome\/(\d+\.\d+)/)) || k),
                        (Q.Zb = da(Q.xa && $a(/Safari\/(\d+\.\d+)/) && $a(/Version\/(\d+\.\d+)/)) || k),
                        (Q.opera = da($a(/Opera\/(\d+\.\d+)/) && $a(/Version\/(\d+\.\d+)/)) || $a(/Opera\/(\d+\.\d+)/) || da(Q.xa && $a(/OPR\/(\d+\.\d+)/)) || k),
                        (Q.dc = -1 < ja[Ka][ib](Cg) || k),
                        (Q.nc = -1 < ja[Ka][ib](wn) || k),
                        (Q.oc = -1 < ja[Ka][ib](xn) || k),
                        (Q.pc = -1 < ja[Ka][ib](yn) || k));
            ...
            var P = {
                ...
                aJ: function (a, b) {
                    ...
                    a[H].MozBorderRadiusBottomright = b;
                    9 > F.$ && tf(a);
                    fa == h && Ic(a);
                },
                bE: function (a, b) {
                    ...
                    if (d != k) {
                        ...
                        if (c != k && 9 > F.$) {
                            ...
                            if (a.hasChildNodes) for (e = 0; e < a[Gc][X]; e++) d[Fb](a[Gc].item(e));
                            d[H].cssText = a[H].cssText;
                            a[dc].replaceChild(d, a);
                            e = Zm;
                            g = d[kb](hm);
                            if (g != k && (g == hm || g == Wf || g == Ki || g == Mp)) e = Mp;
                            g = Zm;
                            f = d[kb](Qn);
                ...
                cZ: function (a, b) {
                    if (Jb(a) != k) ud(a);
                        ...
                        V(d, Rh, d.src);
                        9 > F.$ && b.substr(b[X] - 4)[Fc]() == af && ((d.src = Pc(Ge)), (c = wf(b)[uc](/\%/gi, Md)), V(d, Sh, ca.pb + We + c + Rd), V(d, Qh, ca.pb + $e), se(d));
                        Lc(a);
                ...
                aA: function (a, b) {
                    var c = ia(a, b?.a);
                    ke && (Qc(a, { Ta: 1, ka: zp }, c), (a[H][Te] = Xo));
                    Za(dm, a, c, h);
                },
                aD: function (a, b) {
                    Za(Zn, a, ia(a, b?.a), p);
                ...
                cG: function (a, b) {
                    Qc(a, { Ta: 1, direction: Yo, ib: 30, ka: vp }, ia(a, b?.a));
                },
                cH: function (a, b) {
                    Qc(a, { Ta: 1, direction: On, ib: 30, ka: vp }, ia(a, b?.a));
                },
                cI: function (a, b) {
                    Qc(a, { Ta: 1, direction: Pp, ib: 30, ka: vp }, ia(a, b?.a));
                },
                cJ: function (a, b) {
                    Qc(a, { Ta: 1, direction: Km, ib: 30, ka: vp }, ia(a, b?.a));
                },
                cK: nc,
                cF: nc,
                aM: function (a, b) {
                        ...
                        var c = function (b) {
                            ...
                            if (a[H][Io] == no) {
                                ...
                                w.createEvent
                                    ? (b[gb](),
                                        (c = w.createEvent(zi)),
                                        c.initMouseEvent(b[La], b.bubbles, b.cancelable, b.view, b.detail, b.screenX, b.screenY, b[Rb], b[Sb], b[Ub], b.altKey, b.shiftKey, b.metaKey, b[wb], k),
                                        f.dispatchEvent(c))
                                    : ((c = w.createEventObject()), (c.clientX = b[Rb]), (c.clientY = b[Sb]), f.fireEvent(so + b[La], c), (event.cancelBubble = h));
                            }
                        };
                        Ya(yi, c, a, h);
                        Ya($n, c, a, h);
                ...
                Kj = function b(c) {
                    ...
                    d.ic = function (b) {
                        ...
                        if (j == h) (j = c[0]), (b = sa(j, 0)), d[z](Kb(b, b, b));
                            ...
                            for (var m = c[X], l = 0; l < m - (b[Qa] == h ? 1 : 0); l++)
                                (j = c[l]), 0 == l && d[z](Kb(sa(j, 0), sa(j, 2), Pj(b))), l + 1 == m && b[Qa] == p ? d[z](Kb(sa(j, 6), Oj(b, l), sa(j, 4))) : d[z](Kb(sa(j, 6), sa(c[l + 1], 2), sa(j, 4)));
                        return d;
                    };
                    d.Nb = function (b) {
                        for (var c = d.ba[tb](0), g = -1, j = -1, m = 0, l = 0, n = 0; n < c[X]; n++) {
                            ...
                            if (t.nb == h) m++;
                                ...
                                if (0 < m) {
                                    if (-1 != j) {
                                        if (((j = Nj(c[j], t, m)), (t = c), (m = n - m - 1), !(m >= t[X]))) for (var u = 0; u < j[X]; u++) t[m + u] = j[u];
                                    } else l = m;
                                    m = 0;
                                }
                                -1 == g && (g = n);
                        ...
                        if (1 == c[X]) (t = c[0]), (m = Rg(t.aa, t.aa, t.aa, t.aa)), g[z](m);
                            ...
                            b[Qa] == h && ((m = c[c[X] - 1]), (t = c[0]), (m = Rg(m.aa, m.ha, t.la, t.aa)), g[z](m));
                        }
                        l.path = g;
                        return l;
                    };
                    d.bounds = function () {
                        if (0 == d.ba[X]) return { x: 0, y: 0, width: 0, height: 0 };
                        ...
                        return { x: b, y: g, width: c - b, height: j - g };
                    };
                    d.zb = function (b) {
            ...
            B &&
                ...
                ((B.Common.sin = function (b) {
                    ...
                    (B.Sleeping._motionWakeThreshold = 0.2),
                    (B.Sleeping._motionSleepThreshold = 0.1));
            P.bM = mc;
            P.bU = ff;
            P.bV = ff;
            P.cT = ff;
            ...
            ca.API = {
                ...
                setElementProperty: function (b, c, d, e, f) {
                    var g = { easein: im, easeout: Nm, easeinout: Hl, linear: Yk },
                        j = ok[c];
                    if (j != k && (j.HYP_x != h && (d = bh(d)), nk(b, c) != d)) {
                        ...
                        0 < e && -1 == Ia(l, c)
                            ? ((b = k),
                                f != k && (typeof f === gn ? ((b = th()), (Ad[b] = f)) : (b = g[f])),
                                b == k && (b = Hl),
                                (f = []),
                                fb(f, c, 0, e, b, m, 1, d, h),
                                (d = { i: j, n: j, f: 30, d: e, a: f, b: [] }),
                                (A[U].T[j] = d),
                                we(j, f, d),
                                Lb(j, k, p))
                            : (rb[m] != ba && ((rb[m][c] = j), c == $l && (rb[m].h = j)), (e = la(j)), e != k && Dd(e), W(b, c, d));
                    }
                },
        ...
        v.HYPE == k && ((v.HYPE = v.HYPE_754F), (v.HYPE.documents = {}));
        var R = [];
        v.HYPE_dtl_754F != k && (R = v.HYPE_dtl_754F[tb](0));
        v.HYPE_dtl_754F = [];
