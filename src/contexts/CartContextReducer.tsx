...
const cartContextReducer = (state: CartState, action: CartAction): CartState => {
    ...
    switch (type) {
        ...
        case CART_CONTEXT_ACTIONS.SET_PRODUCT:
            return { ...state, product: action.payload };


        case CART_CONTEXT_ACTIONS.UPDATE_USER_TOKEN:
            return {
                ...state,
                userId: payload,
            };
        case CART_CONTEXT_ACTIONS.TOGGLE_PROMO:
            return {
                ...state,
                promoApplied: payload,
            };
        case CART_CONTEXT_ACTIONS.UPDATE_CART:
            return {
                ...state,
                currentCart: payload,
            };
        case CART_CONTEXT_ACTIONS.UPDATE_ORDER:
            return {
                ...state,
                order: payload,
            };
        case CART_CONTEXT_ACTIONS.UPDATE_ADDRESS:
            return { ...state, localAddressObj: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_ORDER_PLACED:
            return { ...state, orderPlaced: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_SHOW_PHONE_ERROR:
            return { ...state, showPhoneError: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_METHOD:
            return { ...state, method: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_CUSTOMER:
            return { ...state, customer: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_SHOW_PHONE_LOGIN:
            return { ...state, showPhoneLogin: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_SENDING_CODE_TO_NEW_USER:
            return { ...state, sendingCodeToNewUser: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_USER:
            return { ...state, user: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_SHOW_VERIFICATION:
            return { ...state, showVerification: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_IS_SCROLL_ACTIVATED:
        ...
        case CART_CONTEXT_ACTIONS.SET_CURRENT_TAB:
            return { ...state, currentTab: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_PAYMENT_TOKEN:
            return { ...state, paymentToken: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_BRAINTREE_INSTANCE:
            return { ...state, braintreeInstance: payload };
        case CART_CONTEXT_ACTIONS.SET_GLOBAL_ERROR:
            return { ...state, globalError: payload };
        case CART_CONTEXT_ACTIONS.SET_GLOBAL_MESSAGE:
            return { ...state, globalMessage: payload };
        case CART_CONTEXT_ACTIONS.SET_SHOW_CART:
            return { ...state, showCart: payload };
        case CART_CONTEXT_ACTIONS.SET_SHOW_PAY_NOW:
            return { ...state, showPayNow: payload };
        case CART_CONTEXT_ACTIONS.UPDATE_MY_ACCOUNT_QTY:
            return { ...state, myAccountQty: payload };
        case CART_CONTEXT_ACTIONS.SET_SHOW_POPOVER:
            return { ...state, showPopOver: payload };
        case CART_CONTEXT_ACTIONS.SET_PHONE_CHECKED:
            return { ...state, phoneChecked: payload };
        case CART_CONTEXT_ACTIONS.SET_EMAIL_CHECKED:
...
export { cartContextReducer, CART_CONTEXT_ACTIONS };
